...
router.post('/', async (req, res) => {
    try {
        ...
        const message = "Please recommend 10 books for me to read that I might like, considering I enjoy the following books: " + books.join(", ") + ". Please only respond with the list of books in the following format: book1\nbook2\nbook3 etc, do not number them";
